  ...
  return (
    <article className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 
      ...
      <div className="p-6">
        ...
        {/* Title */}
        <h3 className="text-lg font-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-blue-500
        ...
        <div className="flex justify-end">
          <a
            ...
            className="inline-flex items-center px-4 py-2 text-sm font-medium text-blue-500
                     hover:text-white hover:bg-blue-400 border border-blue-400 rounded-lg
